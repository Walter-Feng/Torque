...
TEST_CASE("block sparse tensor operation") {
  ...
  SECTION("block sparse matrix initialization") {
    ...
    torque::BlockSparseTensor<float> tensor(a.data(), arma::uvec{1, 1},
  ...
  SECTION("block sparse matrix transposition") {
    ...
    // 1 3 0
    // 2 4 0
    torque::BlockSparseTensor<float> tensor(a.data(), arma::uvec{2, 0},
  ...
  SECTION("block sparse tensor initialization") {
    ...
    torque::BlockSparseTensor<float> tensor(dimension);
  ...
  SECTION("scalar") {
    ...
    torque::BlockSparseTensor<float> tensor(arma::uvec{});
  ...
  SECTION("matrix multiplication") {
    ...
    const auto A_squared_sparse = sparse_tensor_format.contract(
        sparse_tensor_format, arma::umat({{1, 0}}));
  ...
  SECTION("tensor-vector contraction") {
    ...
    torque::BlockSparseTensor<float> tensor_format({2, 2, 2});
    ...
    torque::BlockSparseTensor<float> vector_in_tensor({2});
